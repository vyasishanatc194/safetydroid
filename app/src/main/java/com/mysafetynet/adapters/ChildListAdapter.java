...
import com.mysafetynet.fragments.ChildListFragment.OnListFragmentInteractionListener;
...
public class ChildListAdapter extends RecyclerView.Adapter<ChildListAdapter.ViewHolder> {
    ...
    public ChildListAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }

 ...
 */
public class ParentSettingScreen extends Fragment {
    ...
    public ParentSettingScreen() {
        // Required empty public constructor
    }

    public static Fragment newInstance() {
        ParentSettingScreen fragment = new ParentSettingScreen();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_parent_setting_screen, container, false);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.imgbtnEdit:
                Intent intent1 = new Intent(getActivity(), ParentEditActivity.class);
                startActivity(intent1);
                break;
            case R.id.relativeEditProfile:
                Intent intent = new Intent(getActivity(), ParentEditActivity.class);
